    ...
    const fetchProfile = async () => {
        ...
        try {
            ...
            if (((_a = err.response) === null || _a === void 0 ? void 0 : _a.status) === 401) {
                ...
                setError(((_c = (_b = err.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.message) || 'Không thể tải thông tin');
            }
        }
        finally {
            setLoading(false);
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold">{user === null || user === void 0 ? void 0 : user.name}</p>
                  <p className="text-sm text-muted-foreground">{user === null || user === void 0 ? void 0 : user.email}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="md:col-span-2 space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <Input value={(user === null || user === void 0 ? void 0 : user.name) || ''} disabled/>
                </div>
                <div>
                  <label className="text-sm font-medium mb-1 block">Email</label>
                  <Input value={(user === null || user === void 0 ? void 0 : user.email) || ''} disabled/>
                </div>
                <div>
                  <label className="text-sm font-medium mb-1 block">Số điện thoại</label>
                  <Input value={(user === null || user === void 0 ? void 0 : user.phone) || ''} disabled/>
                </div>
                <div>
                  <label className="text-sm font-medium mb-1 block">Vai trò</label>
                  <Input value={(user === null || user === void 0 ? void 0 : user.role) === 'admin' ? 'Admin' : 'Khách hàng'} disabled/>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              {addresses.length === 0 ? (<p className="text-muted-foreground">Chưa có địa chỉ nào.</p>) : (<div className="space-y-4">
                  {addresses.map((addr) => (<div key={addr.id} className="rounded border p-4">
