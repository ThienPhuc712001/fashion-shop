...
export default function OrderDetailClient({ orderId }) {
    ...
    const updateStatus = async (newStatus) => {
        ...
        try {
            ...
            toast.error(((_b = (_a = err.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || 'Cập nhật thất bại');
        }
        finally {
            setUpdating(false);
        }
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              {order.paymentUrl && (<Button variant="outline" className="w-full mt-2" asChild>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              {['pending', 'processing', 'shipped', 'delivered', 'cancelled'].map((status) => (<Button key={status} variant={order.status === status ? 'default' : 'outline'} className="w-full justify-start" onClick={() => updateStatus(status)} disabled={updating || order.status === status}>
