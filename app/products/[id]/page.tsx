...
import { Spinner, LoadingPage, ErrorDisplay } from '@/components/ui/spinner';
        ...
        <div className="space-y-4">
          <div className="relative aspect-square overflow-hidden rounded-lg bg-zinc-100">
            ...
            {product.compareAtPrice && product.compareAtPrice > product.price && (
              <div className="absolute left-4 top-4 rounded bg-red-500 px-3 py-1 text-sm font-semibold text-white">
              ...
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className={`h-5 w-5 ${
                      i < Math.floor(product.rating || 0) ? 'text-yellow-400 fill-current' : 'text-zinc-300'
                    }`}
                  />
                ))}
